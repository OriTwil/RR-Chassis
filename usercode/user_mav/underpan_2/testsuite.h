/** @file
 *    @brief MAVLink comm protocol testsuite generated from underpan_2.xml
 *    @see https://mavlink.io/en/
 */
#pragma once
#ifndef UNDERPAN_2_TESTSUITE_H
#define UNDERPAN_2_TESTSUITE_H
...
static void mavlink_test_underpan_2(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

    mavlink_test_underpan_2(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_underpan_2(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
