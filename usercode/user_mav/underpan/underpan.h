...
#define MAVLINK_UNDERPAN_XML_HASH 2994659413885686099
...
#define MAVLINK_MESSAGE_CRCS {{9, 207, 24, 24, 0, 0, 0}, {10, 142, 12, 12, 0, 0, 0}, {12, 139, 24, 24, 0, 0, 0}}
#endif
...
# define MAVLINK_MESSAGE_INFO {MAVLINK_MESSAGE_INFO_CONTROL_SET, MAVLINK_MESSAGE_INFO_SPEED_STATUS, MAVLINK_MESSAGE_INFO_POSTURE}
# define MAVLINK_MESSAGE_NAMES {{ "CONTROL_SET", 9 }, { "POSTURE", 12 }, { "SPEED_STATUS", 10 }}
