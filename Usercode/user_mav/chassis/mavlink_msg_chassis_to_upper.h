...
#define MAVLINK_MSG_ID_CHASSIS_TO_UPPER_LEN 25
#define MAVLINK_MSG_ID_CHASSIS_TO_UPPER_MIN_LEN 25
#define MAVLINK_MSG_ID_11_LEN 25
#define MAVLINK_MSG_ID_11_MIN_LEN 25

#define MAVLINK_MSG_ID_CHASSIS_TO_UPPER_CRC 137
#define MAVLINK_MSG_ID_11_CRC 137
...
#define MAVLINK_MESSAGE_INFO_CHASSIS_TO_UPPER { \
    ...
    {  { "pos_x", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_chassis_to_upper_t, pos_x) }, \
         ...
         { "point", NULL, MAVLINK_TYPE_UINT8_T, 0, 24, offsetof(mavlink_chassis_to_upper_t, point) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CHASSIS_TO_UPPER { \
...
static inline void mavlink_msg_chassis_to_upper_send(mavlink_channel_t chan, float pos_x, float pos_y, float zangle, float xangle, float yangle, float w_z, uint8_t point)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CHASSIS_TO_UPPER_LEN];
    _mav_put_float(buf, 0, pos_x);
 ...
 */
static inline void mavlink_msg_chassis_to_upper_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float pos_x, float pos_y, float zangle, float xangle, float yangle, float w_z, uint8_t point)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  目标点
 */
static inline uint8_t mavlink_msg_chassis_to_upper_get_point(const mavlink_message_t* msg)
{
